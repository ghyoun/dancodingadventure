var TimeKnots = {
  draw: function(id, events, options){
    ...
    .attr("onclick", function(d) {console.log(d); return "redirect('" + d.link + "');"})
    ...
    svg.on("mousemove", function(){
      var timelineRect = document.getElementById('timelineRow').getBoundingClientRect();
      var tipPixels = parseInt(tip.style("height").replace("px", ""));
    return tip.style("top", (timelineRect.top + d3.mouse(this)[1] - 530)+"px").style("left",(timelineRect.left + d3.mouse(this)[0] - 260)+"px");})
